      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center lg:items-start pt-20 pb-16">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-neutral-400 leading-relaxed">
                  <DecryptedText
                    speed={50}
                    animateOn={"view"}
                    text="I am a student passionate about creating websites. During my education and internship, I gained skills in designing and developing websites, including knowledge of React, Next, Tailwind CSS/SCSS/CSS. In my free time, I work on projects that allow me to develop my skills and experiment with new technologies. Exploring new technologies and best practices."
                  />
                </p>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-neutral-200">
                  <DecryptedText speed={90} animateOn={"view"} text="Experience" />
                </h3>
                  ...
                  {experience.map((exp) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-neutral-400">
                        <DecryptedText speed={60} animateOn={"view"} text={exp.company} />
                      </p>
                      <p className="text-sm text-neutral-400">
                        <DecryptedText speed={60} animateOn={"view"} text={exp.period} />
                      </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 py-12 border-t border-neutral-800">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="bg-[#0c0c0c] p-4 rounded-xl border border-[#191919]">
                <p className="font-medium">
                  <DecryptedText speed={70} animateOn={"view"} text="UI/UX Design" />
                </p>
                <p className="text-sm text-neutral-400">
                  <DecryptedText
                    speed={50}
              ...
              <div className="bg-[#0c0c0c] p-4 rounded-xl border border-[#191919]">
                <p className="font-medium">
                  <DecryptedText speed={70} animateOn={"view"} text="Web Performance" />
                </p>
                <p className="text-sm text-neutral-400">
                  <DecryptedText
                    speed={50}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#0c0c0c] p-4 rounded-xl border border-[#191919]">
              ...
              <p className="text-sm text-neutral-400 mt-1">
                <DecryptedText speed={60} animateOn={"view"} text="Poznan, Poland" />
              </p>
              <p className="text-sm text-neutral-400">
                <DecryptedText speed={60} animateOn={"view"} text="2021 - Present" />
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-16 space-y-8">
          <h3 className="text-2xl font-semibold text-neutral-200">
            <DecryptedText speed={90} animateOn={"view"} text="Skills & Tools" />
          </h3>
            ...
            {stack.map((category) => (
              ...
              >
                <h4 className="font-medium mb-4">
                  <DecryptedText speed={70} animateOn={"view"} text={category.name} />
                </h4>
                  ...
                  {category.content.map((tech) => (
                    <div key={tech.name} className="flex flex-col items-center gap-1">
                      ...
                      <span className="text-[10px] text-neutral-400 text-center">
                        <DecryptedText speed={40} animateOn={"view"} text={tech.name} />
                      </span>
                    </div>
                  ))}
                </div>
